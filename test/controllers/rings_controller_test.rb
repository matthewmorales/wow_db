...
class RingsControllerTest < ActionController::TestCase
  ...
  test "should create ring" do
    assert_difference('Ring.count') do
      post :create, ring: { armor: @ring.armor, context: @ring.context, icon: @ring.icon, itemLevel: @ring.itemLevel, name: @ring.name, quality: @ring.quality }
    end
  ...
  test "should update ring" do
    patch :update, id: @ring, ring: { armor: @ring.armor, context: @ring.context, icon: @ring.icon, itemLevel: @ring.itemLevel, name: @ring.name, quality: @ring.quality }
    assert_redirected_to ring_path(assigns(:ring))
  end
