class StatsController < ApplicationController
  ...
  private
    ...
    def stat_params
      params.require(:stat).permit(:health, :powerType, :power, :str, :agi, :int, :sta, :crit, :haste, :mastery, :bonusArmor, :spellPower, :armor, :parry, :block, :attackPower, :mainHandDps, :rangedAttackPower)
    end
end
